...
description: "Apply to sweeps, migrations, or stacked commits/PRs. Break work into small units that each end in a verified state before the next starts — never batch edits then verify once."
---
