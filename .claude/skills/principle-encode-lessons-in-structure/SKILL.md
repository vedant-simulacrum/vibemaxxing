...
description: "Apply when a correction, instruction, or fix repeats for the second time. Encode it as a lint, metadata flag, runtime check, or script — not more prose that will be missed again."
---
