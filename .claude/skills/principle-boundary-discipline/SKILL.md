...
description: "Apply when wiring input validation, error handling, or a framework/MCP/auth adapter. Concentrate guards at boundaries; trust internal types; keep business logic in pure functions."
---
