...
description: "Apply to non-trivial edits, migrations, analyses, or checks — not just bulk work. Build a codemod, script, generator, or skill instead of hand work or a one-off throwaway."
---
# Build the Lever
...
**Balance:** The bar is triviality, not repetition. A one-off still earns a lever when the lever is what makes the work checkable. Keep the lever itself lean: build the smallest script that does or proves the job, never a framework.
