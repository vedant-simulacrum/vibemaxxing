...
description: "Apply when debugging or reaching for a try/except guard. Trace the symptom to its root cause; resist broad exception swallowing and nil-checks that silence crashes."
---
