...
P-1140E must make this traceability machine-checkable and fail when an accepted implementation-bearing decision has no work unit, platform scope, or executable evidence requirement. The validator must also fail if Android, iOS, iPadOS or ChromeOS native work appears without a new accepted decision superseding D-066.