...
| P-401..409 | native topology, storage, IPC, devices and CLI | complete-planning | typed IPC, lineage and updater reopened |
...
| P-901..905 | routes, states, privacy UX and accessibility | complete-planning | evidence/country corrections required |
| P-1001..1006 | updater, observability, deployment and governance | complete-planning | release trust graph reopened |
...
15. TUF root/roles, release-set compatibility, rollback/freeze defense, provenance, transparency and compromise recovery.
16. Remove country routes, tasks and launch gates.
...
| P-1105 | Public-launch readiness review | blocked-launch-evidence | requires implemented system and executable evidence |
...
P-1140A is complete. P-1140B is active. P-1140C–E remain dependency-blocked. P-1104 remains blocked and is not the next task.