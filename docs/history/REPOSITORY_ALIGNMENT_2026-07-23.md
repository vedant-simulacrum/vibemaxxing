...
- the implementation handoff and PR-sized breakdown are broad and dependency ordered, but they cannot be treated as executable handoff authority while the P-1140F repair head awaits independent semantic review;
