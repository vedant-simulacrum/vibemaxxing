...
export function PublicProfileStoryboard() {
  return <ProductShell active="Leaderboard"><main className="vm-sb-content profile">
    ...
    <div className="vm-sb-grid profile-grid"><div className="vm-sb-stack">
      <Panel className="burn-card"><header><h2>Credited Token Burn <span>(30 days)</span> <Info size={16} /></h2><div className="burn-kpis"><div><b>86.4M</b><small>Credited burn</small></div><div className="vm-sb-up"><ArrowUp size={19}/>3<small>Rank movement</small></div></div></header><Tabs labels={["Today","7 days","30 days","Season"]} active="30 days" /><ProductTrendChart label="Credited Token Burn trend" /></Panel>
      ...
      <Panel className="compact-card"><h2>Privacy &amp; evidence</h2><div className="single-row"><ShieldCheck className="green" size={28}/><div><b>Standard evidence</b><small>Evidence profile awarded</small></div><span>May 3, 2025</span><ChevronRight size={19}/></div><p>Profile visibility, model mix, and burn data are public.</p></Panel>
    </aside></div>
  </main></ProductShell>;
}
...
export function RivalComparisonStoryboard() {
  return <ProductShell active="Leaderboard"><main className="vm-sb-content rival-page">
    ...
    <div className="vm-sb-grid rival-grid"><div className="vm-sb-stack">
      <Panel className="compare-chart"><header><h2>Credited Token Burn <span>(30 days)</span></h2><Tabs labels={["Today","7 days","30 days","Season"]} active="30 days"/></header><div className="legend"><i/>Vedant <i className="grey"/>Sam Rivera</div><ProductTrendChart compare label="Vedant and Sam Rivera Credited Token Burn comparison" /></Panel>
